...
<html lang="fr-CA">
	...
	<body>
		...
		<main>
			...
			<div id="advantages">
				<div class="container small">
					<div class="advantage">
						...
						<div class="description">+ de 500 toitures</div>
					</div>
					<div class="advantage">
						<i class="fad fa-bell-on"></i>
						<div class="title">Présence</div>
						<div class="description">service d’urgence 24/7</div>
					</div>
					<div class="advantage">
			...
			<section class="primary diagonal-top" id="services">
				<div class="container">
					<h2>Nos services</h2>
					<ul>
						<li>
