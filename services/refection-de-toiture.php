...
<html lang="fr-CA">
	<head>
		...
		<meta name="description" content="La toiture de votre maison est à refaire? Ça tombe bien, c’est notre spécialité! Obtenez une estimation en ligne en 2 minutes, gratuitement!">
	</head>
	<body>
		...
		<main>
			...
			<section>
				<div class="container">
					...
					<br>
					<a href="https://fr.certainteed.com/residential-roofing/products/landmark/" target="_blank" class="button">
						Consultez les choix de bardeaux Certainteed
						<i class="far fa-external-link"></i>
					</a>
				</div>
			</section>
